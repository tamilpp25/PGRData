...
local function InitStageConfig()
    StageConfig = XTableManager.ReadByIntKey(TABLE_STAGE_PATH, XTable.XTableKillZoneStage, "Id")
    StageBuffConfig = XTableManager.ReadByIntKey(TABLE_STAGE_BUFF_PATH, XTable.XTableKillZoneBuff, "Id")
end
