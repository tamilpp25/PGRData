...
function XArchivePartnerEntity:GetStoryTitle()
    return self:GetArchivePartnerCfg().StoryTitle
end

function XArchivePartnerEntity:GetStoryId()
    return self:GetArchivePartnerCfg().StoryId
end
