XBfrtManagerCreator = function()
    ...
    local EchlonTeamPosDic = {}
    local EchlonFirstFightDic = {}
    ...
    function XBfrtManager.CheckTeam(groupId, fightTeamList, logisticsTeamList, cb)
        ...
        for _, echelonId in ipairs(fightInfoIdList) do
            local captainPos = XBfrtManager.GetTeamCaptainPos(echelonId)
            tableInsert(captainList, captainPos)

            local firstFightPos = XBfrtManager.GetTeamFirstFightPos(echelonId)
    ...
    function XBfrtManager.GetTeamCaptainPos(echelonId)
        return EchlonTeamPosDic[echelonId] or XBfrtConfigs.CAPTIAN_MEMBER_INDEX
    end
    ...
    ---@return number
    ---==========================================
    function XBfrtManager.GetTeamFirstFightPos(echelonId)
        return EchlonFirstFightDic[echelonId] or EchlonTeamPosDic[echelonId] or XBfrtConfigs.FIRST_FIGHT_MEMBER_INDEX
    end
