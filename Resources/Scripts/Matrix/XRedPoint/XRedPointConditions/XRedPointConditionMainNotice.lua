...
function XRedPointConditionMainNotice.Check()
    return XRedPointConditionActivityNewAcitivies.Check() or XRedPointConditionActivityNewNotices.Check()
    or XRedPointConditionActivityNewActivityNotices.Check()
end
