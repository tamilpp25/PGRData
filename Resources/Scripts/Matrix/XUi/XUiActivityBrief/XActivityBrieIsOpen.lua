...
XActivityBrieIsOpen.IsOpenFunc = {
    ...
    [XActivityBriefConfigs.ActivityGroupId.SuperTower] = "SuperTower", --双人同行
    [XActivityBriefConfigs.ActivityGroupId.KillZone] = "KillZone", --双人同行
    [XActivityBriefConfigs.ActivityGroupId.SummerSeries] = "SummerSeries", --双人同行
}
...
function XActivityBrieIsOpen.Reform()
    local beginTime = XDataCenter.ReformActivityManager.GetActivityStartTime()
