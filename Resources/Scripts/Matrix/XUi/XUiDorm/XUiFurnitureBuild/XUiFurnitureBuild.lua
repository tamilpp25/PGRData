...
function XUiFurnitureBuild:OnStart(tabType, drawingId, furnitureTypeId)
    ...
    self:Init(tabType or TAB_TYPE_CREATE, drawingId, furnitureTypeId)
...
function XUiFurnitureBuild:Init(tabType, drawingId, furnitureTypeId)
    self.PanelCreate:Init(self.FurnitureCreateList)
    self.PanelRefit:Init(drawingId, furnitureTypeId)
