...
function XUiBabelTowerTask:OnTaskChangeSync()
    self.BabelTowerTasks = XDataCenter.TaskManager.GetBabelTowerFullTaskList()
    for _, v in pairs(self.BabelTowerTasks or {}) do
        v.SortWeight = 2
    ...
    table.sort(self.BabelTowerTasks, function(taskA, taskB)
