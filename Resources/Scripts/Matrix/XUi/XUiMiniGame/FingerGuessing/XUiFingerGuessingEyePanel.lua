...
function XUiFingerGuessingEyePanel:OnClickBtnOpenEye()
    if self.BtnOpenEye.ButtonState == CS.UiButtonState.Disable then
        ...
        CsXUiManager.Instance:Open("UiDialog", tipTitle, tipContent, XUiManager.DialogType.Normal, nil, function() XDataCenter.FingerGuessingManager.OpenEyes(self.RootUi.StageSelected) end)
    end 
end
