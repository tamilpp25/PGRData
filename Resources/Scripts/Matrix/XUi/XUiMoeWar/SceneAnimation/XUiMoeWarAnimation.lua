...
function XUiMoeWarAnimation:OnStart(animGroupIds, winnerIndex ,closeCallback)
...
function XUiMoeWarAnimation:InitRoles()
    ...
    for index, groupId in pairs(self.GroupIds) do
        ...
        local role = XMoeWarAnimationRole.New(index, groupId, parent, self.Name, self.UiSceneInfo.Transform, switchCameraCb, endAnimCb, goalAnimCb)
...
function XUiMoeWarAnimation:SwitchFollowRoleCamera()
    ...
    self.FollowRoleCameraIndex = index
end
