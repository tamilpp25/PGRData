...
function XUiRpgTowerStageGrid:SetBg()
    self.RImgBtnPress:SetSprite(self.DifficultyData.IconPath)
    self.RImgBtnNormal:SetSprite(self.DifficultyData.IconPath)
    self.RImgBtnSelect:SetSprite(self.DifficultyData.IconPath)
end
--================
--选中事件
--================
