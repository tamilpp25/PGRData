...
function XUiGridQuickDeployTeam:Refresh(echelonId, team, echelonIndex, echelonType, characterLimitType)
    ...
    local firstFightPos = XDataCenter.BfrtManager.GetTeamFirstFightPos(echelonId)
