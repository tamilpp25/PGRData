...
function XUiGridCharacter:UpdateRobotGrid()
    ...
    local head = XDataCenter.CharacterManager.GetCharSmallHeadIcon(robotTemplate.CharacterId, robotTemplate.LiberateLv, true)
...
function XUiGridCharacter:SetSameRoleTag(isShow)
    ...
    if self.TextSameRole and isShow then
        ...
        self.TextSameRole.text = CS.XTextManager.GetText("TeamGridSameRole", characterTypeName)
    end
end