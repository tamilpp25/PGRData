...
function XUiEquipAwarenessPopup:OnNotify(evt, ...)
    ...
    elseif evt == XEventId.EVENT_EQUIPLIST_TAKEOFF_NOTYFY
    or evt == XEventId.EVENT_EQUIP_RECYCLE_NOTIFY then
...
function XUiEquipAwarenessPopup:OnBtnPutOnClick()
    ...
    if wearingCharacterId and wearingCharacterId > 0 then
        ...
        XUiManager.DialogTip(CSXTextManagerGetText("TipTitle"), content, XUiManager.DialogType.Normal, function() end, function()
