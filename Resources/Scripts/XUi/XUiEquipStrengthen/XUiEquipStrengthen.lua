...
function XUiEquipStrengthen:OnStart(equipId, rootUi)
    ...
    self.SelectedTabIndex = XDataCenter.EquipManager.IsStrengthenDefaultUseEquip(equipId) and BtnTabIndex.Equips or BtnTabIndex.Items
...
function XUiEquipStrengthen:OnClickTabCallBack(tabIndex)
    if tabIndex == self.SelectedTabIndex then return end
...
function XUiEquipStrengthen:InitEquipScroll()
    ...
    self.EquipScroll = XUiPanelEquipScroll.New(self, self.PanelEquipScroll, equipTouchCb, gridReloadCb, true, addCountCheckCb)
end
...
function XUiEquipStrengthen:OnBtnStrengthenClick()
    ...
    XDataCenter.EquipManager.LevelUp(self.EquipId, self.SelectEquipIds, self.SelectItemDic, function()
