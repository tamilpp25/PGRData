...
function XUiNieREasterEgg:RealNieREasterEggStoryClick(nextStoryId)
    ...
    elseif storyConfig.Type == XNieRConfigs.EasterEggStoryType.Leave then
        if self.IsWin then
            ...
            if CS.XFight.Instance ~= nil then
                CS.XFight.Instance.InputControl:OnOperationClick(CS.XNpcOperationClickKey.NieREasterLeave, CS.XNpcOperationClickType.KeyDown)
                CS.XFight.Instance.InputControl:OnOperationClick(CS.XNpcOperationClickKey.NieREasterLeave, CS.XNpcOperationClickType.KeyUp)
            end
        end
        self:Close()
    elseif storyConfig.Type == XNieRConfigs.EasterEggStoryType.Revive then
        ...
        elseif self.IsWin then
            ...
            if  CS.XFight.Instance ~= nil then
                CS.XFight.Instance.InputControl:OnOperationClick(CS.XNpcOperationClickKey.NieREasterRevive, CS.XNpcOperationClickType.KeyDown)
                CS.XFight.Instance.InputControl:OnOperationClick(CS.XNpcOperationClickKey.NieREasterRevive, CS.XNpcOperationClickType.KeyUp)
            end
            self:Close()
        end
    end
