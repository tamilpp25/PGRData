...
function XUiRpgTowerRoomCharacter:OnStart(teamData, changePos, cb)
    self.TeamData = teamData
    self.ChangePos = changePos
    local characterId = teamData[changePos]
...
function XUiRpgTowerRoomCharacter:OnDestroy()
...
function XUiRpgTowerRoomCharacter:OnBtnJoinClick()
    local id = self.RCharacter:GetCharacterId()
