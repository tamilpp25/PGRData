...
function XLevelBossFight0014:InitBlackDragon()
    ...
    --生成怪物
    self._blackDragonNpcId = FuncSet.GenerateNpc(self._blackDragonRespawnId, ENpcCampType.Camp2, self._bossBornPos, self._bossBornRot)
...
function XLevelBossFight0014:InitWightDragon()
    --生成怪物
    self._wightDragonNpcId = FuncSet.GenerateNpc(self._wightDragonRespawnId, ENpcCampType.Camp2, self._bossHidePos, self._bossBornRot)
