...
local XLevelGuide1 = XDlcScriptManager.RegLevelLogicScript(9012, "XLevelGuide1Rebuild")
...
function XLevelGuide1:ReGenerateNpc(case)
    self._bossId = FuncSet.GenerateNpc(8004, 2, self._bossDiePosition, self._resetBossRotation1) --在玩家看不见的地方召唤新的boss
