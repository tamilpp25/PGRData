...
XEventId = {
    ...
    EVENT_REFORM_CLOSE_DETAIL = "EVENT_REFORM_CLOSE_DETAIL",
    ...
    --大秘境
    EVENT_RIFT_SEASON = "EVENT_RIFT_SEASON", -- 赛季变化
    ...
    EVENT_ROGUE_SIM_ACTION_POINT_CHANGE = "EVENT_ROGUE_SIM_ACTION_POINT_CHANGE", -- 行动点变更
    ...
    EVENT_ROGUE_SIM_BUILDING_BUY = "EVENT_ROGUE_SIM_BUILDING_BUY", -- 建筑购买
