...
XEventId = {
    ...
    -- 公会宿舍
    EVENT_GUILD_DORM_ROLE_TALK = "EVENT_GUILD_DORM_ROLE_TALK",
    EVENT_GUILD_DORM_ROLE_SHOW_EFFECT = "EVENT_GUILD_DORM_ROLE_SHOW_EFFECT",
    EVENT_GUILD_DORM_ROLE_HIDE_EFFECT = "EVENT_GUILD_DORM_ROLE_HIDE_EFFECT",
