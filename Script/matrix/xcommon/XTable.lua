XTable = {
    ...
    XTableCharDetail = {
        ...
        GeneralSkillIds = {ValueType = "string"},
    },
    ...
    XTableCharacterSkillUpgradeDes = {
        ...
        Name = {ValueType = "string"},
        RefId = {ValueType = "int"},
        SpecificDesNum = {Type = 2, KeyType = "int", ValueType = "string"},
    },
    ...
    XTableStageTeleport = {
        StageId = {ValueType = "int"},
        SkipStageIds = {Type = 1, ValueType = "int"},
        SkipLoadingTypes = {Type = 1, ValueType = "string"},
        KeepPlayingStory = {ValueType = "int"},
    },
    XTableChapterMain = {
        Id = {ValueType = "int"},
    ...
    XTableSkipFunctional = {
        ...
        NotShowUI = {Type = 1, ValueType = "string"},
    },
    ...
    XTableBossSingleGrade = {
        ...
        AfreshId = {ValueType = "int"},
        InheritLevelType = {ValueType = "int"},
    },
    ...
    XTableBossSingleChallengeGroupDistribute = {
        Id = {ValueType = "int"},
        SectionUniqueId = {ValueType = "int"},
        FeatureGroupId = {ValueType = "int"},
    },
    XTableBossSingleChallengeFeatureGroup = {
        Id = {ValueType = "int"},
        FeatureIds = {Type = 1, ValueType = "int"},
    },
    XTableBossSingleChallengeFeature = {
        Id = {ValueType = "int"},
        Name = {ValueType = "string"},
        Icon = {ValueType = "string"},
        TriangleBg = {ValueType = "string"},
        Desc = {ValueType = "string"},
        FightEventIds = {Type = 1, ValueType = "int"},
        IsShowRecommend = {ValueType = "bool"},
    },
    ...
    XTableBfrtChapter = {
        ...
        Cover = {ValueType = "string"},
        RewardIds = {Type = 1, ValueType = "int"},
        RewardTitleList = {Type = 1, ValueType = "string"},
        RewardDescList = {Type = 1, ValueType = "string"},
        BfrtRewardId = {ValueType = "int"},
    },
    XTableBfrtGroup = {
        GroupId = {ValueType = "int"},
        GroupName = {ValueType = "string"},
    ...
    XTableBfrtCourseReward = {
        Id = {ValueType = "int"},
        CourseStars = {Type = 1, ValueType = "int"},
        RewardIds = {Type = 1, ValueType = "int"},
        ShowItems = {Type = 1, ValueType = "string"},
        IsImportantItem = {ValueType = "int"},
    },
    ...
    XTableAccumulatedPayReward = {
        ...
        BigRewardId = {ValueType = "int"},
        SmallRewardId = {ValueType = "int"},
        ExtraPayRewardId = {ValueType = "int"},
        MailId = {ValueType = "int"},
    },
    XTableAccumulatedExtraPayReward = {
        Id = {ValueType = "int"},
        ExtraBigRewardId = {ValueType = "int"},
        ExtraSmallRewardId = {ValueType = "int"},
    },
    ...
    XTablePracticeGroup = {
        ...
        LinkStageIds = {Type = 1, ValueType = "int"},
    },
    ...
    XTableUiPanelTip = {
        ...
        Type = {ValueType = "int"},
        FunctionName = {ValueType = "string"},
        IgnoreOnTerminal = {ValueType = "int"},
    },
    XTableShopGroup = {
        Id = {ValueType = "int"},
    ...
    XTableBabelTowerStageLevelGlobalUnlock = {
        Id = {ValueType = "int"},
        BuffIdList = {Type = 1, ValueType = "int"},
        Level = {ValueType = "int"},
    ...
    XTableBabelTowerBuff = {
        ...
        UnlockScore = {Type = 2, KeyType = "int", ValueType = "int"},
    },
    ...
    XTableGachaCourseReward = {
        ...
        RewardIds = {Type = 1, ValueType = "int"},
        RewardNames = {Type = 1, ValueType = "string"},
    },
    ...
    XTableAssignChapter = {
        ...
        SelectCharSkipId = {Type = 1, ValueType = "int"},
        GroupId = {Type = 1, ValueType = "int"},
        RewardId = {Type = 1, ValueType = "int"},
    ...
    XTableTeachingActivity = {
        ...
        StageId = {Type = 1, ValueType = "int"},
        LinkStageId = {Type = 1, ValueType = "int"},
        ShowRewardId = {ValueType = "int"},
        TreasureId = {Type = 1, ValueType = "int"},
    ...
    XTableLottoReward = {
        ...
        Params = {Type = 1, ValueType = "int"},
        Weights = {Type = 1, ValueType = "int"},
        ShowTimelineName = {ValueType = "string"},
        ShowEffectId = {ValueType = "int"},
    },
    XTableLottoProbShow = {
        Id = {ValueType = "int"},
        LottoId = {ValueType = "int"},
    ...
    XTableStrongholdDistribution = {
        ...
        ExtendBuffId = {Type = 1, ValueType = "int"},
    },
    ...
    XTableStrongholdGroup = {
        ...
        IconBoss = {Type = 1, ValueType = "string"},
    ...
    XTableSameColorGameBoss = {
        ...
        NameIcon = {ValueType = "string"},
        NameEnIcon = {ValueType = "string"},
        AttributeType = {ValueType = "int"},
    },
    XTableSameColorGameRole = {
        ...
        NameIcon = {ValueType = "string"},
        NameEnIcon = {ValueType = "string"},
        AttributeFactorId = {ValueType = "int"},
    },
    ...
    XTableSameColorGameSkill = {
        ...
        SkillParams = {Type = 1, ValueType = "int"},
        ScoreFactor = {ValueType = "float"},
        LowerLimit = {ValueType = "int"},
        UpperLimit = {ValueType = "int"},
        SkillComboType = {ValueType = "int"},
        SkillAttributeFactor = {ValueType = "float"},
    },
    ...
    XTableSameColorGameBuff = {
        ...
        TargetBallIds = {Type = 1, ValueType = "int"},
        Duration = {ValueType = "int"},
    ...
    XTableSameColorSkillEffectShow = {
        SkillId = {ValueType = "int"},
        BeforeRemoveEffectType = {ValueType = "int"},
        BeforeRemoveEffect = {Type = 1, ValueType = "string"},
        RemoveEffectType = {ValueType = "int"},
        RemoveEffect = {Type = 1, ValueType = "string"},
        ChangeBallEffectType = {ValueType = "int"},
        ChangeBallEffect = {Type = 1, ValueType = "string"},
        BallRemoveEffect = {Type = 1, ValueType = "string"},
    },
    ...
    XTableUiBattleShowRole = {
        ...
        HideNodeName = {Type = 1, ValueType = "string"},
        ReadyHideNodeName = {Type = 1, ValueType = "string"},
    ...
    XTableCheatResonance = {
        ...
        WaferResonanceType = {Type = 2, KeyType = "int", ValueType = "string"},
        WaferAwakeCount = {Type = 1, ValueType = "int"},
        OverrunSuitId = {Type = 1, ValueType = "int"},
    },
    ...
    XTableGoldenMinerActivity = {
        ...
        Name = {ValueType = "string"},
        BannerBg = {ValueType = "string"},
        HexSelectStages = {Type = 1, ValueType = "int"},
        HexMapStages = {Type = 1, ValueType = "int"},
    },
    ...
    XTableGoldenMinerPartner = {
        ...
        Name = {ValueType = "string"},
        Prefab = {ValueType = "string"},
        TriggerEffect = {ValueType = "string"},
        TriggerSoundId = {ValueType = "int"},
        MoveSpeed = {ValueType = "int"},
        RangeXMin = {ValueType = "int"},
        RangeXMax = {ValueType = "int"},
        RangeYMin = {ValueType = "int"},
        RangeYMax = {ValueType = "int"},
        IgnoreStoneConfigKey = {ValueType = "string"},
        IntParam = {Type = 1, ValueType = "int"},
        FloatParam = {Type = 1, ValueType = "float"},
        StringParam = {Type = 1, ValueType = "string"},
    },
    ...
    XTableRiftActivity = {
        ...
        ShopId = {Type = 1, ValueType = "int"},
        TaskGroupId = {Type = 1, ValueType = "int"},
        PeriodTimeIds = {Type = 1, ValueType = "int"},
        BackLayers = {Type = 1, ValueType = "int"},
        RankLayerLimits = {Type = 1, ValueType = "int"},
        PeriodDesc = {Type = 1, ValueType = "string"},
        MaxLuckyValue = {ValueType = "int"},
        RankLayerLimit = {ValueType = "int"},
        PeriodName = {Type = 1, ValueType = "string"},
        SeasonTaskGroupId = {ValueType = "int"},
        AttrSetNameLength = {ValueType = "int"},
    },
    XTableRiftChapter = {
        Id = {ValueType = "int"},
        ActivityId = {ValueType = "int"},
    ...
    XTableRiftLayer = {
        ...
        FirstPassDropPluginIds = {Type = 1, ValueType = "int"},
        SweepPluginDropTypeGroupId = {ValueType = "int"},
        SweepPluginDropCountMin = {ValueType = "int"},
        SweepPluginDropCountMax = {ValueType = "int"},
        PeriodFightEventIds = {Type = 1, ValueType = "int"},
    },
    XTableRiftStage = {
        Id = {ValueType = "int"},
        StageId = {ValueType = "int"},
    ...
    XTableRiftPluginDropTypeRandomItem = {
        ...
        Weight = {ValueType = "int"},
        PluginId = {ValueType = "int"},
        PeriodWeights = {Type = 1, ValueType = "int"},
    ...
    XTableRiftPlugin = {
        ...
        Element = {ValueType = "int"},
        Sort = {ValueType = "int"},
        GoldDesc = {ValueType = "string"},
        Season = {ValueType = "int"},
    },
    XTableRiftFilterTag = {
        Id = {ValueType = "int"},
        Name = {ValueType = "string"},
    ...
    XTableRiftTeamAttributeEffect = {
        ...
        EffectType = {ValueType = "int"},
        EffectValue = {ValueType = "int"},
        SystemEffectType = {ValueType = "int"},
        SystemEffectParam = {ValueType = "int"},
    },
    ...
    XTableRiftPluginShopGoods = {
        ...
        TimeId = {ValueType = "int"},
        ConditionId = {Type = 1, ValueType = "int"},
        GoodsType = {ValueType = "int"},
        PluginIds = {Type = 1, ValueType = "int"},
        Weights = {Type = 1, ValueType = "int"},
        ShowPluginId = {ValueType = "int"},
        InactiveWeightIncrease = {ValueType = "int"},
        ActiveWeightIncrease = {ValueType = "int"},
    },
    XTableRiftTask = {
    ...
    XTableRiftLayerDetail = {
        ...
        PluginDropList = {Type = 1, ValueType = "int"},
        LuckPluginDropList = {Type = 1, ValueType = "int"},
    },
    ...
    XTableTransfiniteIsland = {
        Id = {ValueType = "int"},
        IslandImage = {Type = 1, ValueType = "string"},
        StageGroupId = {Type = 1, ValueType = "int"},
    },
    ...
    XTableTransfiniteConfig = {
        ...
        StartMailId = {ValueType = "int"},
        StartMailInterval = {ValueType = "int"},
    },
    ...
    XTableTransfiniteStartStageProgress = {
        Id = {ValueType = "int"},
        LastProgress = {ValueType = "int"},
        StartProgress = {ValueType = "int"},
    },
    ...
    XTableTheatre3ContentLib = {
        ...
        AtkFactor = {Type = 1, ValueType = "int"},
        HpFactor = {Type = 1, ValueType = "int"},
        ConditionId = {ValueType = "int"},
        AddWeight = {ValueType = "int"},
        AddWeightCondition = {ValueType = "int"},
    },
    ...
    XTableTheatre3FightNode = {
        ...
        Difficulty = {ValueType = "int"},
        IsBoss = {ValueType = "int"},
        EquipBoxIds = {Type = 1, ValueType = "int"},
        GoldIds = {Type = 1, ValueType = "int"},
        ItemBoxIds = {Type = 1, ValueType = "int"},
        NodeName = {ValueType = "string"},
    ...
    XTableTheatre3FightStageTemplate = {
        ...
        MonsterGroupId = {Type = 1, ValueType = "int"},
        GroupOrder = {ValueType = "int"},
        IsQubitStage = {ValueType = "int"},
        QubitMonsterGroup = {Type = 1, ValueType = "int"},
        QubitValue = {Type = 1, ValueType = "string"},
        QubitEquipBoxGroup = {Type = 1, ValueType = "int"},
        QubitItemBoxGroup = {Type = 1, ValueType = "int"},
        QubitGoldGroup = {Type = 1, ValueType = "int"},
        FightEventIds = {Type = 1, ValueType = "int"},
        SuggestAbility = {ValueType = "int"},
    ...
    XTableTheatre3EventGroup = {
        ...
        EventId = {ValueType = "int"},
        LinkGroupId = {ValueType = "int"},
        AddWeight = {Type = 1, ValueType = "int"},
        AddWeightCondition = {Type = 1, ValueType = "int"},
    },
    XTableTheatre3NodeShop = {
        Id = {ValueType = "int"},
        DiscountNum = {ValueType = "int"},
        DiscountRate = {ValueType = "int"},
        RewardBoxType = {ValueType = "int"},
        RewardBoxId = {ValueType = "int"},
        GroupId = {Type = 1, ValueType = "int"},
        ConditionId = {Type = 1, ValueType = "int"},
        TitleContent = {ValueType = "string"},
        RoleIcon = {ValueType = "string"},
        ...
        EndDesc = {ValueType = "string"},
        EndComfirmText = {ValueType = "string"},
        EndTitleDesc = {ValueType = "string"},
        EndRoleContent = {ValueType = "string"},
        BgAsset = {ValueType = "string"},
        NodeName = {ValueType = "string"},
        NodeIcon = {ValueType = "string"},
        NodeBg = {ValueType = "string"},
    ...
    XTableTheatre3EventOptionGroup = {
        ...
        QuantumEffectShowType = {ValueType = "int"},
    },
    XTableTheatre3Event = {
        Id = {ValueType = "int"},
        EventId = {ValueType = "int"},
    ...
    XTableTheatre3EquipSuitOnStart = {
        ...
        AddWeightSuitIds = {Type = 1, ValueType = "int"},
        AddWeights = {Type = 1, ValueType = "int"},
    },
    XTableTheatre3Equip = {
        Id = {ValueType = "int"},
        ...
        RecordDamage = {ValueType = "bool"},
        QubitEffectGroupId = {ValueType = "int"},
        QubitEffectDesc = {ValueType = "string"},
        QubitSampleEffectDesc = {ValueType = "string"},
        QubitTraitName = {Type = 1, ValueType = "string"},
        QubitTraitDesc = {Type = 1, ValueType = "string"},
        QubitGlobalFightEventIds = {Type = 1, ValueType = "int"},
    },
    XTableTheatre3EquipSuit = {
        ...
        SimpleEffectDesc = {ValueType = "string"},
        QubitSuitEffectGroupId = {ValueType = "int"},
        QubitDesc = {ValueType = "string"},
        QubitSampleEffectDesc = {ValueType = "string"},
        QubitTraitName = {Type = 1, ValueType = "string"},
        QubitTraitDesc = {Type = 1, ValueType = "string"},
    },
    ...
    XTableTheatre3EffectGroupDesc = {
        EffectGroupId = {ValueType = "int"},
        Type = {ValueType = "int"},
        DescList = {Type = 1, ValueType = "string"},
        BaseValueList = {Type = 1, ValueType = "string"},
    },
    ...
    XTableTheatre3EquipDamageSource = {
        EquipId = {ValueType = "int"},
        BehaviorId = {Type = 1, ValueType = "int"},
        MagicId = {Type = 1, ValueType = "int"},
    },
    ...
    XTableTheatre3QubitLevel = {
        Level = {ValueType = "int"},
        Exp = {ValueType = "int"},
        FightDesc = {ValueType = "string"},
        Title = {ValueType = "string"},
        LevelUpTxt = {ValueType = "string"},
        ScreenEffectUrl = {ValueType = "string"},
        IsShake = {ValueType = "int"},
    },
    XTableTheatre3QubitEffect = {
        Id = {ValueType = "int"},
        QubitA = {ValueType = "int"},
        QubitB = {ValueType = "int"},
        EffectGroupId = {ValueType = "int"},
        CoverId = {ValueType = "int"},
        Desc = {ValueType = "string"},
        IsShake = {ValueType = "int"},
    ...
    XTableTheatre3QubitUpTxt = {
        ...
        QubitType = {ValueType = "int"},
        Value = {ValueType = "int"},
        ShowTxtList = {Type = 1, ValueType = "string"},
    },
    ...
    XTableBlackRockChessActivity = {
        Id = {ValueType = "int"},
        TimeId = {ValueType = "int"},
        ShopReminderTimeId = {ValueType = "int"},
        Name = {ValueType = "string"},
        ...
        ShopIds = {Type = 1, ValueType = "int"},
        CurrencyIds = {Type = 1, ValueType = "int"},
    },
    ...
    XTableBlackRockChessStage = {
        ...
        RetractTimes = {ValueType = "int"},
        Version = {ValueType = "int"},
        ScenePrefab = {ValueType = "string"},
        StageIcon = {ValueType = "string"},
        Name = {ValueType = "string"},
        TargetDesc = {Type = 1, ValueType = "string"},
        HelpKey = {ValueType = "string"},
        EnterStoryId = {ValueType = "string"},
        ExitStoryId = {ValueType = "string"},
        EnterCommunicationId = {ValueType = "int"},
        ExitCommunicationId = {ValueType = "int"},
    },
    ...
    XTableBlackRockChessWeaponSkill = {
        ...
        Type = {ValueType = "int"},
        Cost = {ValueType = "int"},
        InitCd = {ValueType = "int"},
        Cd = {ValueType = "int"},
        Range = {ValueType = "int"},
        IsDefault = {ValueType = "int"},
        IsPassive = {ValueType = "int"},
        IsDizzy = {ValueType = "int"},
        IsPenetrate = {ValueType = "int"},
        Params = {Type = 1, ValueType = "int"},
        Desc = {ValueType = "string"},
        Name = {ValueType = "string"},
        Icon = {ValueType = "string"},
        ...
        AssistHitEffectId = {Type = 1, ValueType = "int"},
    },
    ...
    XTableBlackRockChessCharacter = {
        ...
        Name = {ValueType = "string"},
        Type = {ValueType = "int"},
        WeaponIds = {Type = 1, ValueType = "int"},
        SkillIds = {Type = 1, ValueType = "int"},
        DefaultWeapon = {ValueType = "int"},
        ModelUrl = {ValueType = "string"},
        ControllerUrl = {ValueType = "string"},
        CircleIcon = {ValueType = "string"},
        RectIcon = {ValueType = "string"},
    },
    ...
    XTableBlackRockChessEffect = {
        ...
        IsDirection = {ValueType = "int"},
        InitAngle = {ValueType = "float"},
    },
    XTableChessGrowls = {
        Id = {ValueType = "int"},
        Belong = {ValueType = "int"},
        Duration = {ValueType = "int"},
        BelongArgs = {Type = 1, ValueType = "int"},
        TriggerType = {ValueType = "int"},
        TriggerArgs = {Type = 1, ValueType = "int"},
        CvIds = {Type = 1, ValueType = "int"},
        Text = {Type = 1, ValueType = "string"},
    },
    ...
    XTableConnectingLineActivity = {
        ...
        NpcName = {ValueType = "string"},
        NpcPic = {ValueType = "string"},
        HairPic = {ValueType = "string"},
        StageNum = {ValueType = "int"},
    },
    XTableConnectingLineStage = {
        Id = {ValueType = "int"},
        ActivityId = {ValueType = "int"},
        CostItemNum = {ValueType = "int"},
        ConnectingNum = {ValueType = "int"},
        LightingNum = {ValueType = "int"},
        RewardId = {ValueType = "int"},
        Name = {ValueType = "string"},
        RewardText = {Type = 1, ValueType = "string"},
    },
    XTableConnectingLineGrid = {
        Id = {ValueType = "int"},
        StageId = {ValueType = "int"},
        Row = {ValueType = "int"},
        Column = {Type = 1, ValueType = "int"},
    },
    XTableConnectingLineHead = {
        Id = {ValueType = "int"},
        HeadPic = {ValueType = "string"},
        Color = {ValueType = "string"},
        LineColor = {ValueType = "string"},
        Desc = {ValueType = "string"},
    },
    ...
    XTableSubPackageGroup = {
        ...
        NameEn = {ValueType = "string"},
        Desc = {ValueType = "string"},
        SubPackageId = {Type = 1, ValueType = "int"},
    },
    XTableSubPackage = {
        Id = {ValueType = "int"},
        Name = {ValueType = "string"},
        ...
        Desc = {ValueType = "string"},
        Banner = {ValueType = "string"},
        BindSubIds = {Type = 1, ValueType = "int"},
    },
    XTableSubPackageIntercept = {
        Id = {ValueType = "int"},
        Note = {ValueType = "string"},
        EntryType = {ValueType = "int"},
        SubPackageId = {ValueType = "int"},
        Params = {Type = 1, ValueType = "int"},
    },
    XTableRogueSimActivity = {
        Id = {ValueType = "int"},
        TimeId = {ValueType = "int"},
        GameTimeId = {ValueType = "int"},
        Name = {ValueType = "string"},
        StageIds = {Type = 1, ValueType = "int"},
        SettlePointPerGold = {ValueType = "float"},
        SettlePointPerCity = {ValueType = "int"},
        SettlePointPerMainLevel = {ValueType = "int"},
        SettlePointPerBuilding = {ValueType = "int"},
        SettlePointPerProp = {ValueType = "int"},
        SettlePointPerEvent = {ValueType = "int"},
        CommonPropRewardGroup = {ValueType = "int"},
        CommonBuildingRewardGroup = {ValueType = "int"},
        CommonEvenRewardGroup = {ValueType = "int"},
        CommonCityRewardGroup = {ValueType = "int"},
        CommonMixRewardGroup = {ValueType = "int"},
    },
    XTableRogueSimStage = {
        Id = {ValueType = "int"},
        PreStageId = {ValueType = "int"},
        TimeId = {ValueType = "int"},
        GameTimeId = {ValueType = "int"},
        LevelGroup = {ValueType = "int"},
        Name = {ValueType = "string"},
        NameIcon = {ValueType = "string"},
        FirstFinishReward = {ValueType = "int"},
        Type = {ValueType = "int"},
        Desc = {ValueType = "string"},
        AreaRandomGroupIds = {Type = 1, ValueType = "int"},
        MaxTurnCount = {ValueType = "int"},
        TokenId = {ValueType = "int"},
        InitResourceIds = {Type = 1, ValueType = "int"},
        InitResourceCounts = {Type = 1, ValueType = "int"},
        InitCommodityIds = {Type = 1, ValueType = "int"},
        InitCommodityCounts = {Type = 1, ValueType = "int"},
        SettlePoinPerCoin = {ValueType = "int"},
        SettleCoinMin = {ValueType = "int"},
        SettleCoinMax = {ValueType = "int"},
        StarConditions = {Type = 1, ValueType = "int"},
        StarRewardIds = {Type = 1, ValueType = "int"},
        StarDescs = {Type = 1, ValueType = "string"},
    },
    XTableRogueSimToken = {
        Id = {ValueType = "int"},
        Name = {ValueType = "string"},
        ...
        Icon = {ValueType = "string"},
        Rare = {ValueType = "int"},
        RogueSimVolatilityGroupId = {ValueType = "int"},
        IsShowCity = {ValueType = "bool"},
        BuffIds = {Type = 1, ValueType = "int"},
        Effect = {ValueType = "int"},
        Params = {Type = 1, ValueType = "int"},
    },
    XTableRogueSimAreaRandomGroup = {
        Id = {ValueType = "int"},
        AreaIds = {Type = 1, ValueType = "int"},
        Weights = {Type = 1, ValueType = "int"},
    },
    XTableRogueSimArea = {
        Id = {ValueType = "int"},
        Level = {ValueType = "int"},
        EnterTypes = {Type = 1, ValueType = "int"},
        ExitTypes = {Type = 1, ValueType = "int"},
        LandFormRandomIds = {Type = 1, ValueType = "int"},
        FocusGridId = {ValueType = "int"},
    },
    XTableRogueSimLandformRandom = {
        Id = {ValueType = "int"},
        LandformId = {ValueType = "int"},
        MinCount = {ValueType = "int"},
        MaxCount = {ValueType = "int"},
        FillLandformId = {ValueType = "int"},
    },
    XTableRogueSimAreaGrid = {
        ...
        PosX = {ValueType = "int"},
        PosY = {ValueType = "int"},
        TerrainId = {ValueType = "int"},
        LandformId = {ValueType = "int"},
        ParentId = {ValueType = "int"},
        RandomGroupId = {ValueType = "int"},
        RewardDropId = {ValueType = "int"},
    },
    XTableRogueSimIllustrate = {
        Id = {ValueType = "int"},
        Type = {ValueType = "int"},
        Key = {Type = 1, ValueType = "int"},
        StoryGroupId = {ValueType = "int"},
        StoryGroupName = {ValueType = "string"},
        StoryDesc = {ValueType = "string"},
        UnlockTips = {ValueType = "string"},
    },
    ...
    XTableRogueSimLandform = {
        ...
        Name = {ValueType = "string"},
        GridCount = {ValueType = "int"},
        LandType = {ValueType = "int"},
        Model = {ValueType = "string"},
        ModelCenterIcon = {ValueType = "string"},
        ModelSideIcon = {ValueType = "string"},
        EventPool = {ValueType = "int"},
        FinishLandformId = {ValueType = "int"},
        IsPreview = {ValueType = "bool"},
        IsExplored = {ValueType = "bool"},
        Icon = {ValueType = "string"},
        BriefDesc = {ValueType = "string"},
        Description = {ValueType = "string"},
        TipId = {ValueType = "int"},
        TipTurnNumber = {ValueType = "int"},
    },
    ...
    XTableRogueSimBuilding = {
        ...
        Icon = {ValueType = "string"},
        Type = {ValueType = "int"},
        EventRefreshTurnCount = {ValueType = "int"},
        EventRefreshType = {ValueType = "int"},
        EventRewardGroupId = {ValueType = "int"},
        CostResourceIds = {Type = 1, ValueType = "int"},
        CostResourceCounts = {Type = 1, ValueType = "int"},
        BuffIds = {Type = 1, ValueType = "int"},
        EffectIds = {Type = 1, ValueType = "int"},
        TipId = {ValueType = "int"},
    },
    XTableRogueSimCommodity = {
        ...
        Icon = {ValueType = "string"},
        MaxCount = {ValueType = "int"},
        CostResourceCount = {ValueType = "int"},
        Production = {ValueType = "int"},
        ProduceIncreaseRate = {ValueType = "int"},
        ProduceCriticalChanceRate = {ValueType = "int"},
        ProduceCriticalBonusRate = {ValueType = "int"},
        Price = {ValueType = "int"},
        PriceIncreaseRate = {ValueType = "int"},
        SellCriticalChanceRate = {ValueType = "int"},
        SellCriticalBonusRate = {ValueType = "int"},
        MaxPriceRate = {ValueType = "int"},
        MinPriceRate = {ValueType = "int"},
        WarningPercent = {Type = 1, ValueType = "int"},
        WarningText = {Type = 1, ValueType = "string"},
        WarningColor = {Type = 1, ValueType = "string"},
        BubbleGroupId = {ValueType = "int"},
    },
    XTableRogueSimReward = {
        Id = {ValueType = "int"},
        Tag = {ValueType = "int"},
        Types = {Type = 1, ValueType = "int"},
        ItemIds = {Type = 1, ValueType = "int"},
        Nums = {Type = 1, ValueType = "int"},
    },
    XTableRogueSimRewardGroup = {
        Id = {ValueType = "int"},
        Type = {ValueType = "int"},
        RandomType = {ValueType = "int"},
        RewardIds = {Type = 1, ValueType = "int"},
        Weights = {Type = 1, ValueType = "int"},
        Params = {Type = 1, ValueType = "int"},
    },
    ...
    XTableRogueSimTech = {
        Id = {ValueType = "int"},
        TechType = {ValueType = "int"},
        Rare = {ValueType = "int"},
        Level = {ValueType = "int"},
        Cost = {ValueType = "int"},
        PreIds = {Type = 1, ValueType = "int"},
        BuffIds = {Type = 1, ValueType = "int"},
        Name = {ValueType = "string"},
        Icon = {ValueType = "string"},
        Desc = {ValueType = "string"},
    ...
    XTableRogueSimTechLevel = {
        Id = {ValueType = "int"},
        Num = {ValueType = "int"},
        Techs = {Type = 1, ValueType = "int"},
        NextUnlockLevel = {ValueType = "int"},
    },
    XTableRogueSimTip = {
        Id = {ValueType = "int"},
        Content = {ValueType = "string"},
    ...
    XTableRogueSimVolatilityGroup = {
        Id = {ValueType = "int"},
        Condition = {ValueType = "int"},
        VolatilityIds = {Type = 1, ValueType = "int"},
        Weights = {Type = 1, ValueType = "int"},
    },
    XTableRogueSimProp = {
        Id = {ValueType = "int"},
        Stacked = {ValueType = "int"},
        Tag = {ValueType = "int"},
        Duration = {ValueType = "int"},
        Rare = {ValueType = "int"},
        BuffIds = {Type = 1, ValueType = "int"},
    ...
    XTableRogueSimCity = {
        ...
        BriefDesc = {ValueType = "string"},
        Desc = {ValueType = "string"},
        TaskRandomGroupId = {ValueType = "int"},
        BuffIds = {Type = 1, ValueType = "int"},
        EffectIds = {Type = 1, ValueType = "int"},
    },
    XTableRogueSimTask = {
        Id = {ValueType = "int"},
        TaskName = {ValueType = "string"},
        TaskDesc = {ValueType = "string"},
        ConditionId = {ValueType = "int"},
        ConditionParams = {Type = 1, ValueType = "int"},
        BuffIds = {Type = 1, ValueType = "int"},
    },
    ...
    XTableRogueSimMainLevel = {
        ...
        Icon = {ValueType = "string"},
        SmallIcon = {ValueType = "string"},
        LevelUpResourceIds = {Type = 1, ValueType = "int"},
        LevelUpResourceCounts = {Type = 1, ValueType = "int"},
        UnlockAreaIdx = {ValueType = "int"},
        UnlockTechLevel = {ValueType = "int"},
        RewardResourceIds = {Type = 1, ValueType = "int"},
        RewardResourceCounts = {Type = 1, ValueType = "int"},
    },
    XTableRogueSimEvent = {
        Id = {ValueType = "int"},
        Repeatable = {ValueType = "bool"},
        Duration = {ValueType = "int"},
        Condition = {ValueType = "int"},
        SuspendDesc = {ValueType = "string"},
        Name = {ValueType = "string"},
        Text = {ValueType = "string"},
        OptionIds = {Type = 1, ValueType = "int"},
        ExpireEffectIds = {Type = 1, ValueType = "int"},
    },
    XTableRogueSimEventOption = {
        ...
        CostResourceIds = {Type = 1, ValueType = "int"},
        CostResourceCounts = {Type = 1, ValueType = "int"},
        CostCommodityIds = {Type = 1, ValueType = "int"},
        CostCommodityCounts = {Type = 1, ValueType = "int"},
        BuffIds = {Type = 1, ValueType = "int"},
        EffectIds = {Type = 1, ValueType = "int"},
        NextEventId = {ValueType = "int"},
    },
    XTableRogueSimCommodityBubble = {
        Id = {ValueType = "int"},
        Name = {ValueType = "string"},
        MethodName = {ValueType = "string"},
    },
    XTableRogueSimCommodityBubbleGroup = {
        Id = {ValueType = "int"},
        Price = {Type = 1, ValueType = "int"},
        SpecialPrice = {Type = 1, ValueType = "int"},
        Production = {Type = 1, ValueType = "int"},
        SpecialProduction = {Type = 1, ValueType = "int"},
    },
    ...
    XTableBirthdayPeriod = {
        ...
        TimeId = {ValueType = "int"},
        MailId = {ValueType = "int"},
        IsSingleStory = {ValueType = "int"},
    },
    XTableSingleStory = {
        Id = {ValueType = "int"},
        PeriodChapterId = {ValueType = "int"},
        Name = {ValueType = "string"},
        Gender = {ValueType = "string"},
        HalfBodyImg = {ValueType = "string"},
        FullBodyImg = {ValueType = "string"},
        Text = {ValueType = "string"},
        MovieId = {ValueType = "string"},
        IsShow = {ValueType = "int"},
        IsVoiceover = {ValueType = "int"},
        CharacterIds = {Type = 1, ValueType = "int"},
    },
    ...
    XTableAnniversaryReviewPictures = {
        ...
        FocusPointUi = {ValueType = "string"},
        DisplayShowUI = {Type = 1, ValueType = "string"},
        ScreenShotShowUI = {Type = 1, ValueType = "string"},
    },
    ...
    XTableKotodamaActivity = {
        ...
        TaskGroupId = {ValueType = "int"},
        ShowItem = {Type = 1, ValueType = "int"},
        PrologueId = {ValueType = "string"},
        EpilogueId = {ValueType = "string"},
    },
    XTableKotodamaStage = {
        Id = {ValueType = "int"},
        OpenTime = {ValueType = "int"},
        SentencePatterns = {Type = 1, ValueType = "int"},
        CharacterGroup = {ValueType = "int"},
        StageTitle = {ValueType = "string"},
        StageTitleEx = {ValueType = "string"},
        StageContent = {ValueType = "string"},
        Order = {ValueType = "int"},
        ShowMonsterName = {Type = 1, ValueType = "string"},
        ShowMonsterIcon = {Type = 1, ValueType = "string"},
        StageIcon = {ValueType = "string"},
    },
    XTableKotodamaWord = {
        Id = {ValueType = "int"},
        PhraseId = {ValueType = "int"},
        Content = {ValueType = "string"},
    },
    ...
    XTableKotodamaSentence = {
        Id = {ValueType = "int"},
        PatternId = {ValueType = "int"},
        Words = {Type = 1, ValueType = "int"},
        FightEventIds = {Type = 1, ValueType = "int"},
        Title = {ValueType = "string"},
        TitleFormat = {ValueType = "string"},
        ExtraContent = {ValueType = "string"},
        EndContent = {ValueType = "string"},
        IsCollect = {ValueType = "int"},
    },
    XTableKotodamaSentencePattern = {
        Id = {ValueType = "int"},
        Content = {ValueType = "string"},
        PhraseId = {ValueType = "int"},
        DefaultWords = {Type = 1, ValueType = "int"},
        Target = {ValueType = "int"},
        BlockNum = {ValueType = "int"},
    },
    XTableKotodamaWordBlock = {
        Id = {ValueType = "int"},
        AnchoredX = {ValueType = "float"},
        AnchoredY = {ValueType = "float"},
        BlockWidth = {ValueType = "int"},
        UIWidth = {ValueType = "float"},
    },
    XTableFangKuaiActivity = {
        Id = {ValueType = "int"},
        TimeId = {ValueType = "int"},
        ChapterIds = {Type = 1, ValueType = "int"},
        TaskTimeLimitIds = {Type = 1, ValueType = "int"},
        HelpId = {ValueType = "string"},
        MaxItemCount = {ValueType = "int"},
        MinOnGroundLineCount = {ValueType = "int"},
    },
    ...
    XTableFangKuaiStage = {
        ...
        SizeX = {ValueType = "int"},
        SizeY = {ValueType = "int"},
        MaxBlockLength = {ValueType = "int"},
        InitLineCount = {ValueType = "int"},
        MaxRound = {ValueType = "int"},
        EnvironmentId = {ValueType = "int"},
        ShowItem = {Type = 1, ValueType = "int"},
    },
    ...
    XTableFangKuaiBlockPoint = {
        Id = {ValueType = "int"},
        BlockType = {ValueType = "int"},
        BlockLength = {ValueType = "int"},
        Point = {ValueType = "int"},
    },
    XTableFangKuaiStageBlockRule = {
        Id = {ValueType = "int"},
        StageId = {ValueType = "int"},
        MinLine = {ValueType = "int"},
        MaxLine = {ValueType = "int"},
        Type = {ValueType = "int"},
        IsLoop = {ValueType = "bool"},
        FixBlockXs = {Type = 1, ValueType = "int"},
        FixBlockLengths = {Type = 1, ValueType = "int"},
        MaxBlockLengths = {Type = 1, ValueType = "int"},
        MaxBlockLengthWeights = {Type = 1, ValueType = "int"},
        FillBlockCounts = {Type = 1, ValueType = "int"},
        FillBlockCountWeights = {Type = 1, ValueType = "int"},
        SpaceCounts = {Type = 1, ValueType = "int"},
        SpaceCountWeights = {Type = 1, ValueType = "int"},
    },
    XTableFangKuaiCombo = {
        Id = {ValueType = "int"},
        Radio = {ValueType = "int"},
    ...
    XTableFangKuaiStageItemRule = {
        ...
        MaxLine = {ValueType = "int"},
        ItemIds = {Type = 1, ValueType = "int"},
        ItemIdWeights = {Type = 1, ValueType = "int"},
        MinRefreshInterval = {ValueType = "int"},
        MaxRefreshInterval = {ValueType = "int"},
    },
    XTableFangKuaiNpcAction = {
        Id = {ValueType = "int"},
        Model = {ValueType = "string"},
        Kind = {ValueType = "int"},
        StandbyAnim = {Type = 1, ValueType = "string"},
        AttackAnim = {Type = 1, ValueType = "string"},
        JoyfulAnim = {Type = 1, ValueType = "string"},
        BossStandbyAnim = {Type = 1, ValueType = "string"},
        BossAttackAnim = {Type = 1, ValueType = "string"},
        MoveFangKuaiAnim = {Type = 1, ValueType = "string"},
    },
    XTableFangKuaiBrickFace = {
        Id = {ValueType = "int"},
        FacePic = {Type = 1, ValueType = "string"},
    },
    XTableFangKuaiBlockTexture = {
        Id = {ValueType = "int"},
        HeadImage = {ValueType = "string"},
        BodyImage = {ValueType = "string"},
        TailImage = {ValueType = "string"},
        StandaloneImage = {ValueType = "string"},
        Standby = {Type = 1, ValueType = "string"},
        BossStandby = {Type = 1, ValueType = "string"},
    },
    XTableUiModelOffWeaponBoneBind = {
        ModelId = {ValueType = "string"},
        IsOffBindBone = {ValueType = "int"},
        ActionId = {Type = 1, ValueType = "string"},
        WeaponCaseName = {Type = 1, ValueType = "string"},
    },
    ...
    XTableAccumulateExpendReward = {
        Id = {ValueType = "int"},
        TaskId = {ValueType = "int"},
        IsSpecialShow = {ValueType = "bool"},
        IsMainReward = {ValueType = "bool"},
    },
    XTableMainLine2Main = {
        Id = {ValueType = "int"},
        Title = {ValueType = "string"},
        ...
        OrderId = {ValueType = "int"},
        ChapterIds = {Type = 1, ValueType = "int"},
        AchievementId = {ValueType = "int"},
        RedTimeId = {ValueType = "int"},
    },
    XTableMainLine2Chapter = {
        ...
        ActivityCondition = {ValueType = "int"},
        OpenCondition = {ValueType = "int"},
        StageGroupIds = {Type = 1, ValueType = "int"},
        PrefabName = {ValueType = "string"},
        BgStageIndexs = {Type = 1, ValueType = "int"},
        TitleTextColors = {Type = 1, ValueType = "string"},
        LeftTimeTextColors = {Type = 1, ValueType = "string"},
        ProgressTextColors = {Type = 1, ValueType = "string"},
        TreasureId = {ValueType = "int"},
        AchievementId = {ValueType = "int"},
        SkipIds = {Type = 1, ValueType = "int"},
        SkipConditions = {Type = 1, ValueType = "int"},
        SkipIcons = {Type = 1, ValueType = "string"},
        SkipNames = {Type = 1, ValueType = "string"},
    },
    ...
    XTableMainLine2Stage = {
        Id = {ValueType = "int"},
        StageDetailType = {ValueType = "int"},
        TransformCondition = {ValueType = "int"},
        TransformStageId = {ValueType = "int"},
        Ignore = {ValueType = "bool"},
        UnlockCondition = {ValueType = "int"},
        ProgressConditions = {Type = 1, ValueType = "int"},
        ProgressGreyBg = {ValueType = "string"},
        ProgressBg = {ValueType = "string"},
        AchievementTpyes = {Type = 1, ValueType = "int"},
        AchievementNames = {Type = 1, ValueType = "string"},
        AchievementDescs = {Type = 1, ValueType = "string"},
        VideoId = {ValueType = "int"},
        Specialorder = {ValueType = "string"},
        MonsterHead = {ValueType = "string"},
        MonsterHalfBody = {ValueType = "string"},
    },
    XTableMainLine2Treasure = {
        Id = {ValueType = "int"},
        StageCounts = {Type = 1, ValueType = "int"},
        RewardIds = {Type = 1, ValueType = "int"},
        HighlightRewardIds = {Type = 1, ValueType = "int"},
    },
    XTableMainLine2Achievement = {
        Id = {ValueType = "int"},
        Count = {ValueType = "int"},
        ClearRewardId = {ValueType = "int"},
        Icon = {ValueType = "string"},
        ChapterIcon = {ValueType = "string"},
        ChapterEffect = {ValueType = "string"},
    },
    ...
    XTableGardenSceneBlockInfo = {
        Id = {ValueType = "int"},
        Row = {ValueType = "int"},
        Col = {ValueType = "int"},
        EntityIdList = {ValueType = "string"},
    },
    ...
    XTableTempleFairStage = {
        ...
        ChapterId = {ValueType = "int"},
        StageName = {ValueType = "string"},
        StageDesc = {ValueType = "string"},
        StageKind = {ValueType = "int"},
        TimeId = {ValueType = "int"},
        LastStage = {ValueType = "int"},
        StageNpc = {ValueType = "int"},
        StarNumberScore = {Type = 1, ValueType = "int"},
        Bg = {ValueType = "string"},
        Message = {ValueType = "string"},
        DetailBg = {ValueType = "string"},
        ImageNumber = {ValueType = "string"},
    },
    XTableTempleGrid = {
        Id = {ValueType = "int"},
        Icon = {ValueType = "string"},
        Name = {ValueType = "string"},
        Type = {ValueType = "int"},
        RotateIcon = {ValueType = "int"},
        FusionType = {ValueType = "int"},
        Fusion = {Type = 1, ValueType = "string"},
    },
    XTableTempleTime = {
        Id = {ValueType = "int"},
        Icon = {ValueType = "string"},
        Name = {ValueType = "string"},
        IconOn = {ValueType = "string"},
        IconOff = {ValueType = "string"},
    },
    XTableTempleStageGame = {
        Id = {ValueType = "int"},
        OptionRound = {ValueType = "int"},
        OptionId = {ValueType = "int"},
        OptionBlock = {ValueType = "int"},
        OptionReward = {ValueType = "int"},
        OptionSpend = {ValueType = "int"},
        RuleId = {ValueType = "int"},
        RuleName = {ValueType = "string"},
        RuleType = {ValueType = "int"},
        RuleParams = {Type = 1, ValueType = "int"},
        RuleTime = {Type = 1, ValueType = "int"},
        RuleScore = {ValueType = "int"},
        RuleIsHide = {ValueType = "int"},
        Rule4Grid = {ValueType = "int"},
        Map = {Type = 1, ValueType = "int"},
        Time = {ValueType = "int"},
        TimeDuration = {ValueType = "int"},
    },
    XTableTempleRule = {
        Id = {ValueType = "int"},
        Text = {ValueType = "string"},
    ...
    XTableTempleBlock = {
        Id = {ValueType = "int"},
        Name = {ValueType = "string"},
        Grid1 = {Type = 1, ValueType = "int"},
        Grid2 = {Type = 1, ValueType = "int"},
        Grid3 = {Type = 1, ValueType = "int"},
        Grid4 = {Type = 1, ValueType = "int"},
        Grid5 = {Type = 1, ValueType = "int"},
        Grid6 = {Type = 1, ValueType = "int"},
    },
    XTableTempleConstConfig = {
        Key = {ValueType = "string"},
        Value = {ValueType = "int"},
        ValueStr = {ValueType = "string"},
    },
    ...
    XTableTempleNpc = {
        ...
        TextStageEnter = {Type = 1, ValueType = "string"},
        TextStageSettle = {Type = 1, ValueType = "string"},
        TextRefreshBlock = {Type = 1, ValueType = "string"},
        TextChooseBlock = {Type = 1, ValueType = "string"},
        TextMoveBlock = {Type = 1, ValueType = "string"},
        TextRotateBlock = {Type = 1, ValueType = "string"},
        TextCancelBlock = {Type = 1, ValueType = "string"},
        TextFail = {Type = 1, ValueType = "string"},
        SmartPutDownBlock = {ValueType = "int"},
    },
    ...
    XTableDlcServerStageThreadMaxLoad = {
        StageNo = {ValueType = "int"},
        MaxLoad = {ValueType = "int"},
    },
    XTableDlcHuntChip = {
        Id = {ValueType = "int"},
        Type = {ValueType = "int"},
    ...
    XTableDlcHuntWorld = {
        ...
        WorldType = {ValueType = "int"},
        MatchTimeoutSec = {ValueType = "int"},
    },
    ...
    XTableDlcCasualActivity = {
        ...
        TimeId = {ValueType = "int"},
        Type = {ValueType = "int"},
        TutorialWorldId = {ValueType = "int"},
        TutorialLevelId = {ValueType = "int"},
        HelpId = {ValueType = "int"},
        CharacterPoolId = {ValueType = "int"},
        ChapterIds = {Type = 1, ValueType = "int"},
        TaskGroupIds = {Type = 1, ValueType = "int"},
    },
    XTableDlcCasualChapter = {
        ...
        Name = {ValueType = "string"},
        WorldIds = {Type = 1, ValueType = "int"},
        LevelIds = {Type = 1, ValueType = "int"},
        WorldDesc = {Type = 1, ValueType = "string"},
    },
    ...
    XTableDlcCharacterCute = {
        ...
        TradeName = {ValueType = "string"},
        HeadIcon = {ValueType = "string"},
        RoundHeadImage = {ValueType = "string"},
        MVPAction = {ValueType = "string"},
        VictoryAction = {ValueType = "string"},
        FailAction = {ValueType = "string"},
    },
    XTableDlcCasualScore = {
        WorldId = {ValueType = "int"},
        JudgeScore = {Type = 1, ValueType = "int"},
        JudgeName = {Type = 1, ValueType = "string"},
        CubeRankMaxTeamScore = {ValueType = "int"},
    },
    ...
    XTableNpcAttrib = {
        ...
        AntiAttackMagic5 = {ValueType = "fix"},
        ...
        DamageMagic5ChangeP = {ValueType = "fix"},
        ...
        AntiDamageMagic5ChangeP = {ValueType = "fix"},
        ...
        BrokenProtectorHp = {ValueType = "fix"},
        BrokenProtectorHpChangeP = {ValueType = "fix"},
        AntiBrokenProtectorHpChangeP = {ValueType = "fix"},
        AllMagicDamageChangeP = {ValueType = "fix"},
        AllMagicAntiChangeP = {ValueType = "fix"},
    },
    XTableSkillRelease = {
        Id = {ValueType = "int"},
        SkillId = {ValueType = "int"},
        SkillGroupId = {ValueType = "int"},
        BtnName = {ValueType = "int"},
        InputInfo = {ValueType = "int"},
        InputParam1 = {ValueType = "fix"},
        InputParam2 = {ValueType = "fix"},
        InputParam3 = {ValueType = "fix"},
        Priority = {ValueType = "int"},
        SkillTiming = {ValueType = "int"},
        LastSkill = {ValueType = "string"},
        NeedBuff = {ValueType = "string"},
        ReleaseType = {ValueType = "int"},
        EnemyDistance = {ValueType = "float"},
    },
    ...
    XTableUiFightCerberusDialogBox = {
        ...
        Name = {ValueType = "string"},
        Desc = {ValueType = "string"},
        ShowTime = {ValueType = "int"},
        CvList = {Type = 1, ValueType = "int"},
    },
}
