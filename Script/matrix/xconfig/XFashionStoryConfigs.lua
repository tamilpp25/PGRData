...
--end
--
--function XFashionStoryConfigs.GetActivityIdOpened()
--    for i, config in pairs(FashionStory) do
...
XFashionStoryConfigs = {}
setmetatable(XFashionStoryConfigs,
        {
            __index = function(table, key, value)
                XLog.Error("[XFashionStoryConfigs] 涂装剧情, 该副本暂时被屏蔽，请在优化后提交，如有问题，请联系立斌，谢谢")
            end
        })