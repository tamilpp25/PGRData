XFubenManagerCreator = function()
    ...
    function XFubenManager.GetStageRelationInfos()
        return XMVCA.XFuben:GetStageRelationInfos()
    end
    ...
    function XFubenManager.InitStageInfoNextStageId()
        return XMVCA.XFuben:InitStageInfoNextStageId()
    end
    ...
    function XFubenManager.EnterBfrtFight(stageId, team, captainPos, firstFightPos)
        return XMVCA.XFuben:EnterBfrtFight(stageId, team, captainPos, firstFightPos)
    end

    function XFubenManager.EnterStrongholdFight(stageId, characterIds, captainPos, firstFightPos)
        return XMVCA.XFuben:EnterStrongholdFight(stageId, characterIds, captainPos, firstFightPos)
    end
    ...
    function XFubenManager.EnterAssignFight(stageId, charIdList, captainPos, startCb, errorCb, firstFightPos)
        return XMVCA.XFuben:EnterAssignFight(stageId, charIdList, captainPos, startCb, errorCb, firstFightPos)
    end

    function XFubenManager.EnterAwarenessFight(stageId, charIdList, captainPos, startCb, errorCb, firstFightPos)
        return XMVCA.XFuben:EnterAwarenessFight(stageId, charIdList, captainPos, startCb, errorCb, firstFightPos)
    end
    ...
    function XFubenManager.GetStageMaxChallengeCount(stageId,enableLog)
        return XMVCA.XFuben:GetStageMaxChallengeCount(stageId,enableLog)
    end
