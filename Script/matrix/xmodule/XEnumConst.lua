XEnumConst = {
    ...
    BLACK_ROCK_CHESS = {
        EVENT_FUNC_ID = {
            ...
            HIDE_HP_HUD = 4,
            BROADCAST_ROUND = 5,
            CAMERA_DISTANCE_CHANGED = 6,
            PREVIEW_DAMAGE = 7,
            FOCUS_ENEMY = 8,
            CANCEL_FOCUS_ENEMY = 9,
            REFRESH_CHECK_MATE = 10,
            CLOSE_BUBBLE_SKILL = 11,
            SHOW_DIALOG_BUBBLE = 12,
            SHOW_BUFF_HUD = 13,
            HIDE_BUFF_HUD = 14,
            REFRESH_SELECT_ROLE = 15,
            SHOW_GROWLS = 16,
            HIDE_GROWLS = 17,
            FOCUS_SELECT_ACTOR = 18,
        },
        WEAPON_SKILL_TYPE = {
            SHOTGUN_ATTACK = 1,
            SHOTGUN_SKILL1 = 2,
    ...
    RogueSim = {
        ...
        MapAreaOverlookTime = 0.5,              -- 地图区域解锁的 移动/镜头拉远 时间
        -- 地貌类型
        LandformType = {
            Main = 1,                           -- 主城
            City = 2,                           -- 城邦
    ...
    GOLDEN_MINER = {
        ...
        STONE_TYPE = {                  -- 抓取物类型
            ...
            HOOK_DIRECTION_POINT = 9,   -- 转向点(改变钩爪方向物体、不可被抓起)
            MUSSEL = 10,                -- 河蚌
            QTE = 11,                   -- QTE类型
            PROJECTION = 12,            -- 投影
            PROJECTOR = 13,             -- 投影仪
        ...
        BUFF_TYPE = {
            ...
            HOOK_KARENINA = 32,     -- Skill-钩爪速度随着出钩次数提升，并可以直接抓取转向器（土木老姐）
