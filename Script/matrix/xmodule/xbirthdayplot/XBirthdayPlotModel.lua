...
function XBirthdayPlotModel:GetSingleStoryList()
    if not XTool.IsTableEmpty(self._SingleStoryList) 
            and self._CachePeriodId == self._ActiveChapterId then
    ...
    for _, template in pairs(templates) do
        if template.PeriodChapterId == self._ActiveChapterId then
