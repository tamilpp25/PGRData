...
function XCerberusGameAgency:CheckPassedByStageId(stageId)
    return self:GetXStageById(stageId):GetIsPassed()
end
...
function XCerberusGameAgency:GetBassRoleIdListForStoryMode(difficulty)
    local allRoleIds = {}
...
function XCerberusGameAgency:GetCanSelectRoleListForStoryMode(xStoryPoint)
    ...
    local baseRoleList = self:GetBassRoleIdListForStoryMode(self:GetLastSelectStoryLineDifficulty())
