...
function XUiGridAnniversaryReviewData:Refresh(type)
    self.Type=type
    if type==XEnumConst.Anniversary.ReviewDataType.PlayerBaseData then
    ...
    elseif type==XEnumConst.Anniversary.ReviewDataType.ActionData then
    ...
    elseif type==XEnumConst.Anniversary.ReviewDataType.CharaData1 then
    ...
    elseif type==XEnumConst.Anniversary.ReviewDataType.CharaData2 then
    ...
    elseif type==XEnumConst.Anniversary.ReviewDataType.ActivityProcess1 then
    ...
    elseif type==XEnumConst.Anniversary.ReviewDataType.ActivityProcess2 then
    ...
    elseif type==XEnumConst.Anniversary.ReviewDataType.Reward1 then
    ...
    elseif type==XEnumConst.Anniversary.ReviewDataType.Reward2 then
        if not self.DynamicTable then
