local XUiPanelTeamRank = XClass(nil, "XUiPanelTeamRank")
...
function XUiPanelTeamRank:Refresh(index)
    ...
    self.TxtTime.text = XDataCenter.ArenaManager.GetArenaTeamRankTime(index)
    ...
    self.ImgEmpty.gameObject:SetActiveEx(#self.DataList == 0)
