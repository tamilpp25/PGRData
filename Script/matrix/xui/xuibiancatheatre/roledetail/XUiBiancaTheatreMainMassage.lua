...
--        end
--
--        local priorityA = XMVCA.XCharacter:GetCharacterPriority(XEntityHelper.GetCharacterIdByEntityId(idA))
--        local priorityB = XMVCA.XCharacter:GetCharacterPriority(XEntityHelper.GetCharacterIdByEntityId(idB))
