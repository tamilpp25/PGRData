...
function XUiFubenBossSingleTrialDetail:OnStart(bossId)
    ...
    self._BossId = bossId
    self._Index = XDataCenter.FubenBossSingleManager.GetCurTrialBossIndex(bossId)
...
function XUiFubenBossSingleTrialDetail:_SelectTabGroup()
    if self._Index then
        ...
        local index = XDataCenter.FubenBossSingleManager.GetCurTrialBossIndex(self._BossId)
...
function XUiFubenBossSingleTrialDetail:_RefreshDesc()
    ...
    local bossCurScore = XDataCenter.FubenBossSingleManager.GetTrialTotalScoreInfo()[self._BossId]
...
function XUiFubenBossSingleTrialDetail:_RefreshInfo()
    ...
    local stageData = XDataCenter.FubenBossSingleManager.GetTrialStageInfo(self._CurBossStageConfig.StageId)
