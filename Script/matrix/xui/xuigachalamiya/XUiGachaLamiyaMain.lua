                ...
                self._TipCbTrigger = function()
                    ...
                    RunAsyn(function()
                        if XTool.IsNumberValid(templateId) then
                            asynOpen("UiGachaLamiyaQuickWear", templateId, self._GachaCfg.CourseRewardId, isConvertFrom, rewardName)
                        end
                        if fashionItem then
                            asynOpen("UiGachaLamiyaPassport", fashionItem)
                        end
                        if backgroundItem then
                            asynOpen("UiGachaLamiyaPassport", backgroundItem)
                        end
