...
function XUiGachaLamiyaTip:OnPcSelectedIdChanged(newSelectedId)
    self:ShowCurrentRainbowCard(newSelectedId)
end

function XUiGachaLamiyaTip:ShowCurrentRainbowCard(selectedId)
...
function XUiGachaLamiyaTip:ShowCurrentAndOther(current, other)
...
function XUiGachaLamiyaTip:OnBtnPCSwichClick()
    self:SwitchRainbowCard()
end

function XUiGachaLamiyaTip:SwitchRainbowCard()
