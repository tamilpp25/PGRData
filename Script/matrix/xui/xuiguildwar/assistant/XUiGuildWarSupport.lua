...
function XUiGuildWarSupport:Init()
    local uiPanelAsset = XUiPanelAsset.New(self, self.PanelAsset, XDataCenter.ItemManager.ItemId.GuildWarCoin)
    ...
    -- reward icon
    local itemId = XDataCenter.ItemManager.ItemId.GuildWarCoin
