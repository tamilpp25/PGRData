...
function XUiLogin:OnStart(...)
    ...
    self.BtnVideo.gameObject:SetActiveEx(isPlayVideo)
...
function XUiLogin:PlaySpineAnimation()
    ...
    -- local spineAnimState = spineGo:GetComponent("SkeletonGraphic").AnimationState
    -- spineAnimState:SetAnimation(0, "Began", false)
