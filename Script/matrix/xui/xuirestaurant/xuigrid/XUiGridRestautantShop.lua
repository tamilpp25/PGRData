...
function XUiGridRestautantShop:Ctor()
    local haveBuyCountColor = XRestaurantConfigs.GetShopBuyLimitColor(1)
    local notBuyCountColor = XRestaurantConfigs.GetShopBuyLimitColor(2)
