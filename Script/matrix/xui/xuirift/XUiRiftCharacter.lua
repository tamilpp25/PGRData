...
function XUiRiftCharacter:UpdateRightCharacterInfo()
    ...
    local elementIcons = {}
    table.insert(elementIcons, XCharacterConfigs.GetCharElement(charConfig.Element).Icon)
...
function XUiRiftCharacter:OnBtnCareerTipsClick()
    XLuaUiManager.Open("UiCharacterCareerTipsV2P6", self.CurrSelectRole:GetCharacterId())
end
