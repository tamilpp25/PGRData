...
function XUiRogueSimMain:OnGetEvents()

end

function XUiRogueSimMain:OnGetLuaEvents()

end

function XUiRogueSimMain:OnNotify(event, ...)
...
function XUiRogueSimMain:OnDestroy()
