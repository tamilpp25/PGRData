...
---@field PanelTaskOn UiObject
---@field PanelTaskOff UiObject
...
function XUiGridRogueSimCity:RefreshBuff()
...
function XUiGridRogueSimCity:RefreshTask()
...
function XUiGridRogueSimCity:RefreshTaskBuff(configId, gridBuff)
