...
function XUiPanelRogueSimEvent:Refresh()
    ...
    table.sort(eventIds, function(a, b)
        local isDurEventA = self._Control.MapSubControl:CheckIsEventDuration(a) and 1 or 0
        local isDurEventB = self._Control.MapSubControl:CheckIsEventDuration(a) and 1 or 0
    ...
    if #eventIds > 0 then
        ...
        local isDurEvent = self._Control.MapSubControl:CheckIsEventDuration(self.EventId)
