...
function XUiRogueSimBattle:OnDestroy()
...
function XUiRogueSimBattle:RefreshRedPoint()
    ...
    -- TODO
    -- 贸易红点
    local isSellShow = self._Control.ResourceSubControl:CheckSellRedPoint()
    self.BtnSell:ShowReddot(isSellShow)
    -- 生产红点
    local isProduceShow = self._Control.ResourceSubControl:CheckProduceRedPoint()
    self.BtnProduce:ShowReddot(isProduceShow)
end
