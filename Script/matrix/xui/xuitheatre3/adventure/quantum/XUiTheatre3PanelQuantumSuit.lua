...
function XUiTheatre3PanelQuantumSuit:_InitEquipLabel(suitId)
    ...
    for i, equipConfig in ipairs(self._Control:GetAllSuitEquip(suitId)) do
        ---@type XUiTheatre3PanelQuantumSuitNumberLabel
        local numberLabel = {}
        XTool.InitUiObjectByUi(numberLabel, i == 1 and self.PanelNum or XUiHelper.Instantiate(self.PanelNum, self.PanelNum.parent))
